...
class UsersImport implements ToModel, WithStartRow,WithHeadingRow
{
    public function model(array  $row)
    {
        ...
        return new User([
            ...
            //check if the coming date is is numeric of date formate
            ...
            'salary' => $row["salary"],
            'profileimage' => '/uploads/profileimages/'.$row["employee_name"] . '.jpg',
            'pdf' =>'/uploads/userdoc/'. $row["employee_name"] . '.zip',
