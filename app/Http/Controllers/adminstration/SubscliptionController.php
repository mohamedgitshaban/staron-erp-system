...
use App\Models\Subscliption;
use Illuminate\Http\Request;
use Illuminate\Http\Response;

class SubscliptionController extends Controller
{
    public function index()
    {
        $data=Subscliption::latest()->where("status","pending")->get();
        if(!$data->isEmpty()){
