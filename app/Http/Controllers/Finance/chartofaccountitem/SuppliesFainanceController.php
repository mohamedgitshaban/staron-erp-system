...
class SuppliesFainanceController extends Controller
{
    protected static $Suppliesid = '162';
    ...
    public function index(){
        $data = ChartAccount::with('childrenRecursive')->where('parent_id',self::$Suppliesid)->get();
        if (!$data->isEmpty()) {
