...
class MiscelleneousFainanceController extends Controller
{
    protected static $Miscelleneousid = '164';
    ...
    public function index(){
        $data = ChartAccount::with('childrenRecursive')->where('parent_id',self::$Miscelleneousid)->get();
        if (!$data->isEmpty()) {
